...
````bash
vim /root/.config/scfproxy/sdk.toml
````
...
```bash
./scfproxy list http
./scfproxy clear http -p alibaba -r eu-*
```



![image-20221222223918593](image/%E4%BD%BF%E7%94%A8%E4%BA%91%E5%87%BD%E6%95%B0%E5%81%9A%E4%BB%A3%E7%90%86.assets/image-20221222223918593.png)
...
```
./scfproxy clear socks -p alibaba -r eu-*
```
