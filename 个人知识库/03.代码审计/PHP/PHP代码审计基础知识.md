...
![img](image/PHP代码审计基础知识/20200818234802.png)
...
![img](image/PHP代码审计基础知识/20200819181726.png)
...
![img](image/PHP代码审计基础知识/20200819211747.png)
...
![img](image/PHP代码审计基础知识/20200819235236.png)
...
![img](image/PHP代码审计基础知识/20200820001152.png)
...
![img](image/PHP代码审计基础知识/20200830215933.png)
...
- include_path：可选。就是你可以指定搜索的路径位置，如果要指定的话，那么该参数要指定为- context：可选。规定句柄的环境。
...
![img](image/PHP代码审计基础知识/20200828220802.png)
...
![img](image/PHP代码审计基础知识/20200828223749.png)
...
![img](image/PHP代码审计基础知识/20200830112047.png)
...
![img](image/PHP代码审计基础知识/20200830141143.png)
...
![img](image/PHP代码审计基础知识/20200830153532.png)
...
![img](image/PHP代码审计基础知识/20200830161758.png)
...
![img](image/PHP代码审计基础知识/20200830164518.png)
...
![img](image/PHP代码审计基础知识/20200830173037.png)
...
![img](image/PHP代码审计基础知识/20200830174239.png)
...
![img](image/PHP代码审计基础知识/20200830193825.png)
...
![img](image/PHP代码审计基础知识/20200831092854.png)
...
![img](image/PHP代码审计基础知识/20200830211454.png)
...
![img](image/PHP代码审计基础知识/20200831094439.png)
...
![img](image/PHP代码审计基础知识/20200830213118.png)

这里简单介绍一下phar的大致应用，更详细可以参考[seebug (opens new window)](https://paper.seebug.org/680/)。
...
![img](image/PHP代码审计基础知识/20200826211734.png)

我们看到，`%ff`直接没了，而是直接输出前面的的文件名，这个可以用来绕过一些正则匹配。原因就在于`%ff`在通过 url 传参时会被 url 解码，解码成了不可见字符，满足了`basename`函数对文件名的非ASCII值去除的特点，从而被删掉。

## 参考文献

[狼组安全团队公开知识库](https://wiki.wgpsec.org/knowledge/code-audit/php-code-audit.html#php%E4%BB%A3%E7%A0%81%E5%AE%A1%E8%AE%A1%E5%9F%BA%E7%A1%80%E7%9F%A5%E8%AF%86)