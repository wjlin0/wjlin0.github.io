...
![img](image/12.Python-IDE.assets/pycharm_ui_darcula.png)
...
![img](image/12.Python-IDE.assets/sublimetext.jpg)
...
![img](image/12.Python-IDE.assets/Snap5.gif)

会弹出一个窗口让你选择Python的安装位置，选择你安装Python的所在位置。

![img](image/12.Python-IDE.assets/Snap6.gif)
...
![img](image/12.Python-IDE.assets/Snap7.gif)

会弹出一个新窗口，填写Project Name，以及项目保存地址，然后点击next完成项目的创建。

![img](image/12.Python-IDE.assets/Snap8.gif)

### 5、创建新的Pydev Module

光有项目是无法执行的，接着必须创建新的Pydev Moudle，选择File -> New -> Pydev Module

![img](image/12.Python-IDE.assets/Snap9.gif)

在弹出的窗口中选择文件存放位置以及Moudle Name，注意Name不用加.py，它会自动帮助我们添加。然后点击Finish完成创建。

![Snap10](image/12.Python-IDE.assets/Snap10.gif)

输入"hello world"的代码。

![img](image/12.Python-IDE.assets/Snap11.gif)

### 6、执行程序

程序写完后，我们可以开始执行程序,在上方的工具栏上面找到执行的按钮。

![img](image/12.Python-IDE.assets/Snap13.gif)

之后会弹出一个让你选择执行方式的窗口，通常我们选择Python Run，开始执行程序。

![Snap14](image/12.Python-IDE.assets/Snap14.gif)
